class Project < ActiveRecord::Base
  ...
  LICENSES = {
    ...
    cc0: {
      ...
      dedication_html: "To the extent possible under copyright law, the author has waived all \
copyright and related or neighboring rights to this work."
    },
    mit: {
      name: 'MIT License',
      url: 'http://opensource.org/licenses/MIT',
      dedication_html: "This work is licensed under an <a href=\"http://opensource.org/licenses/MIT\">\
MIT License</a>."
    },
    public_domain: {
      name: 'Public Domain',
