...
<<<<<<< HEAD
ActiveRecord::Schema.define(version: 20_210_801_180_154) do
=======
ActiveRecord::Schema.define(version: 20190917151630) do

>>>>>>> 3c13a53 (Most of the integration work)
  ...
  create_table 'brand_memberships', id: :serial, force: :cascade do |t|
    ...
    t.index %w[brand_id invitation_token],
name: 'index_brand_memberships_on_brand_id_and_invitation_token', unique: true
